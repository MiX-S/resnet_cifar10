...
"""
Realisation of resnet20 and resnet110 with blocks.
This code is from:
...
def resnet110(use_batch_norm=True, use_drop_out=False, d_out_p=0.5):
    return ResNet(BasicBlock, [18, 18, 18], use_batch_norm=use_batch_norm, 
                  use_drop_out=use_drop_out, d_out_p=d_out_p)
  
  
def resnet20(use_batch_norm=True, use_drop_out=False, d_out_p=0.5):
    return ResNet(BasicBlock, [3, 3, 3], use_batch_norm=use_batch_norm, 
                  use_drop_out=use_drop_out, d_out_p=d_out_p) 
